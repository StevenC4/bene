...
if __name__ == '__main__':
    ...
    # setup network
    net = Network('networks/2-nodes/1Mbps-1s.txt')
    ...
    # setup network
    net = Network('networks/2-nodes/100bps-10ms.txt')
    ...
    # setup network
    net = Network('networks/2-nodes/1Mbps-10ms.txt')
    ...
    # setup network
    net = Network('networks/3-nodes/2-fast-links.txt')
    ...
    # setup network
    net = Network('networks/3-nodes/2-fast-links-upgraded.txt')
    ...
    # setup network
    net = Network('networks/3-nodes/1-fast-link-1-slow-link.txt')
